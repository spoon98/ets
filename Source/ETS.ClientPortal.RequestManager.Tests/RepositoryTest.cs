...
using ETS.ClientPortal.Infrastructure.Data.Repositories.Domain.Specification;
using ETS.ClientPortal.Core.Interface.Repository;
using ETS.ClientPortal.Infrastructure.Data.Repositories.Domain;

namespace ETS.ClientPortal.Tests.Data.Repository
{
    [TestFixture]
    public class RepositoryTest
    {
        ...
        {            
            ...
            ObjectContextManager.Init("DSI", new[] { "ETS.ClientPortal.Infrastructure.Data" }, true);

            customerRepository = new CustomerRepository();
            repository = new ETS.ClientPortal.Infrastructure.Data.EntityFramework.Repositories.GenericRepository();
        }
